...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"D:\New Project\Facial-Recognition-for-Crime-Detection-master\img\back.png")
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file=r"D:\New Project\Facial-Recognition-for-Crime-Detection-master\img\previous.png")
        next_img = tk.PhotoImage(file=r"D:\New Project\Facial-Recognition-for-Crime-Detection-master\img\next.png")
...
def showCriminalProfile(name):
    ...
    crim_data={}
    data=[]
    file_path="D:\\New Project\\Facial-Recognition-for-Crime-Detection-master\\Criminal.csv"
    ...
    # print(id,crim_data)
    file_path = r"D:\New Project\Facial-Recognition-for-Crime-Detection-master\profile_pics"

    # Read the first image from the directory
    profile_img = cv2.imread(file_path + "\\criminal 1.png")
    # path = os.path.join("profile_pics", "criminal %d.png"n)
...
logo = tk.PhotoImage(file = r"D:\New Project\Facial-Recognition-for-Crime-Detection-master\img\logo2.png")
